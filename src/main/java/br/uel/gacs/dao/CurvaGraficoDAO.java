...
public class CurvaGraficoDAO {
    ...
    public int excluirPorCurva(Connection c,Long id)throws SQLException{try(PreparedStatement p=c.prepareStatement("DELETE FROM CurvaGrafico WHERE idCurva=?")){p.setLong(1,id);return p.executeUpdate();}}
